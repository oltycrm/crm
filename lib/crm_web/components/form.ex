defmodule CrmWeb.Components.Form do
  ...
  def switch(assigns) do
    ...
    <label class="relative inline-flex items-center justify-center flex-shrink-0 w-10 h-5 group">
      ...
      <span class="absolute h-6 mx-auto transition-colors duration-200 ease-in-out bg-neutral-200 border rounded-full pointer-events-none w-11 dark:bg-neutral-700 dark:border-neutral-600 peer-checked:bg-primary-500">
      </span>
  ...
  defp label_classes(assigns) do
    ...
    "#{if field_has_errors?(assigns), do: "has-error", else: ""} #{type_classes} text-sm block text-neutral-900 dark:text-neutral-200"
  end

  defp text_input_classes(has_error) do
    "#{if has_error, do: "has-error", else: ""} border-neutral-300 focus:border-primary-500 focus:ring-primary-500 dark:border-neutral-600 dark:focus:border-primary-500 sm:text-sm block disabled:bg-neutral-100 disabled:cursor-not-allowed shadow-sm w-full rounded-md dark:bg-neutral-800 dark:text-neutral-300 focus:outline-none focus:ring-primary-500 focus:border-primary-500"
  end

  defp select_classes(has_error) do
    "#{if has_error, do: "has-error", else: ""} border-neutral-300 focus:border-primary-500 focus:ring-primary-500 dark:border-neutral-600 dark:focus:border-primary-500 block w-full disabled:bg-neutral-100 disabled:cursor-not-allowed pl-3 pr-10 py-2 text-base focus:outline-none sm:text-sm rounded-md dark:border-neutral-600 dark:focus:border-primary-500 dark:text-neutral-300 dark:bg-neutral-800"
  end

  defp file_input_classes(has_error) do
    "#{if has_error, do: "has-error", else: ""} focus:outline-none file:border-0 rounded-md text-sm text-slate-500 file:text-primary-700 file:font-semibold file:px-4 file:py-2 file:mr-6 file:rounded-md hover:file:bg-primary-100 file:bg-primary-200 dark:file:bg-neutral-800 dark:file:text-primary-500"
  end

  defp color_input_classes(has_error) do
    "#{if has_error, do: "has-error", else: ""} border-neutral-300 focus:border-primary-500 focus:ring-primary-500 dark:border-neutral-600 dark:focus:border-primary-500"
  end

  defp range_input_classes(has_error) do
    "#{if has_error, do: "has-error", else: ""} border-neutral-300 focus:border-primary-500 focus:ring-primary-500 dark:border-neutral-600 dark:focus:border-primary-500 w-full"
  end

  defp checkbox_classes(has_error) do
    "#{if has_error, do: "has-error", else: ""} border-neutral-300 text-primary-700 rounded w-5 h-5 ease-linear transition-all duration-150 dark:bg-neutral-800 dark:border-neutral-300"
  end
  ...
  defp switch_classes(has_error) do
    "#{if has_error, do: "has-error", else: ""} absolute w-10 h-5 bg-white border-none rounded-full cursor-pointer peer checked:border-0 checked:bg-transparent checked:focus:bg-transparent checked:hover:bg-transparent dark:bg-neutral-800"
  end
  ...
  defp radio_classes(has_error) do
    "#{if has_error, do: "has-error", else: ""} border-neutral-300 h-4 w-4 cursor-pointer text-primary-600 focus:ring-primary-500 dark:bg-neutral-800 dark:border-neutral-300"
  end
