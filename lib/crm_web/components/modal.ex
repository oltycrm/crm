defmodule CrmWeb.Components.Modal do
  ...
  def custom_modal(assigns) do
    ...
    <div {@rest} id="modal">
      <div
        id="modal-overlay"
        class="fixed inset-0 z-50 transition-opacity bg-neutral-900 animate-fade-in dark:bg-neutral-900 bg-opacity-30 dark:bg-opacity-70"
        aria-hidden="true"
      >
      </div>
      ...
      >
        ...
        >
          <!-- Header -->
          <div class="px-5 py-3 border-b border-neutral-100 dark:border-neutral-700">
  ...
  defp get_classes(assigns) do
    ...
    base_classes =
      "animate-fade-in-scale w-full max-h-full overflow-auto bg-white rounded shadow-lg dark:bg-neutral-800"
