defmodule CrmWeb.Components.Typography do
  ...
  defp get_heading_classes(base_classes, assigns) do
    ...
    color_classes = assigns[:color_class] || "text-neutral-900 dark:text-white"
    underline_classes = if assigns[:underline], do: " border-b border-neutral-200 pb-2", else: ""
  ...
  defp text_base_class(), do: "leading-5 text-neutral-600 dark:text-neutral-400"
