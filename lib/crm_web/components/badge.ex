defmodule CrmWeb.Components.Badge do
  ...
  defp get_color_classes(%{color: "neutral", variant: variant}) do
    case variant do
      "light" ->
        "text-neutral-800 bg-neutral-100 border-neutral-100 dark:bg-neutral-200 dark:border-neutral-200"

      "dark" ->
        "text-white bg-neutral-600 border-neutral-600 dark:bg-neutral-700 dark:border-neutral-700"
